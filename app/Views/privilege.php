...
<?= $this->section('content') ?>
    ...
    <style>
        ...
        .form-title {
            ...
            color: #333;
            text-align: center;
            border-bottom: 3px solid #b41616;
            padding-bottom: 15px;
        }
        ...
        .privileges-options label:hover {
            background-color: #e9ecef;
        }

        .privileges-options input[type="checkbox"] {
            width: 18px;
            height: 18px;
            accent-color: #b41616;
            cursor: pointer;
