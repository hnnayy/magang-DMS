    ...
    <ul class="menu">
        ...
        <li class="has-submenu">
           ...
           <ul class="submenu">
                ...
                <li><a href="<?= base_url('create-user/user-role') ?>"><i class="fi fi-rr-user-pen"></i> User Role</a></li>
        ...
        <li class="has-submenu <?= (strpos(uri_string(), 'dokumen') !== false) ? 'open' : '' ?>">
            ...
            <li>
                <a href="<?= base_url('dokumen/config-jenis-dokumen') ?>">
                    <i class="fi fi-rr-clipboard-list"></i> Jenis & Kode Dokumen
                </a>
            </li>
