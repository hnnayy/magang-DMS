...
<head>
    ...
    <title>Kelola Dokumen - Daftar Pengajuan</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="main-section">
            ...
            <div class="section-header">
                <h1 class="section-title">Kelola Dokumen</h1>
                <p class="section-subtitle">Daftar Pengajuan</p>
            </div>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        <tr class="table-row">
                            ...
                            <td class="table-cell">Prosedur perubahan data</td>
                            <td class="table-cell number">00</td>
                            <td class="table-cell">Instruksi kerja dan prosedur</td>
                            <td class="table-cell">Keterangan Panjang</td>
                            <td class="table-cell">Keterangan Panjang</td>
                            <td class="table-cell">
                                <div class="actions">
                                    <button class="action-btn edit" title="Edit"><svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-edit"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M7 7h-1a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-1" /><path d="M20.385 6.585a2.1 2.1 0 0 0 -2.97 -2.97l-8.415 8.385v3h3l8.385 -8.415z" /><path d="M16 5l3 3" /></svg>
                                    </button></button>
                                    <button class="action-btn delete" title="Delete"><svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-trash"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 7l16 0" /><path d="M10 11l0 6" /><path d="M14 11l0 6" /><path d="M5 7l1 12a2 2 0 0 0 2 2h8a2 2 0 0 0 2 -2l1 -12" /><path d="M9 7v-3a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v3" /></svg></button>
                                    <button class="action-btn check" title="Check"><svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-check"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 12l5 5l10 -10" /></svg></button>
                                </div>
                            </td>
                        </tr>
                        <tr class="table-row">
    ...
    <script>
        ...
        document.querySelectorAll('.action-btn').forEach(btn => {
            btn.addEventListener('click', function() {
                const action = this.classList.contains('edit') ? 'Edit' : 
                              this.classList.contains('delete') ? 'Delete' : 'Check';
                const row = this.closest('.table-row');
                const docName = row.cells[3].textContent;
                alert(`${action} action for: ${docName}`);
            });
        });
        ...
        document.querySelectorAll('.export-btn').forEach(btn => {
            btn.addEventListener('click', function() {
                const type = this.textContent.trim().split(' ')[1] || this.textContent.trim();
