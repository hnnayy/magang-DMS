...
class SubmenuController extends BaseController
{
    ...
    public function store()
    {
        $rules = [
            ...
            'submenu' => [
                ...
                'errors' => ['regex_match' => 'Submenu harus terdiri dari minimal dua kata.']
            ],
        ...
        return redirect()->to('create-submenu')->with('swal', [
            'icon'  => 'success',
            'title' => 'Success',
    ...
    public function checkDuplicate()
    {
        ...
        return $this->response->setJSON(['exists' => $existing ? true : false]);
    }
